 ...
 *                      Uses USART2 to send HID keyboard reports via CH9329
 *                      protocol transmission mode (mode 0, default).
 *
...
/*********************************************************************
 * @fn      CH9329_UART2_Init
 *
 * @brief   Initialize USART2: 115200 baud, 8N1, TX + RX.
 ...
 * @fn      CH9329_CalcSum
 *
 * @brief   Calculate CH9329 checksum: sum of all frame bytes.
 *          SUM = HEAD0 + HEAD1 + ADDR + CMD + LEN + DATA[0..N-1]
 *
 ...
 * @fn      CH9329_SendFrame
 *
 * @brief   Build and transmit a complete CH9329 protocol frame.
 *
 * @param   cmd   Command code (0x01-0x3F).
 * @param   len   Data length (0-64).
 ...
 * @fn      CH9329_Init
 *
 * @brief   Initialize CH9329 driver (USART2 hardware).
 *
 * @return  none
 *********************************************************************/
...
/*********************************************************************
 * @fn      CH9329_SendKeyboard
 *
 * @brief   Send an 8-byte HID keyboard report to CH9329.
 *          CH9329 converts this to a standard USB keyboard HID report.
 *
 * @param   hid_data  8-byte HID keyboard data:
 *                    [0] = modifier bitmask (Ctrl/Shift/Alt/GUI)
 *                    [1] = reserved (must be 0x00)
 *                    [2..7] = up to 6 HID key codes (0x00 = empty)
 *
