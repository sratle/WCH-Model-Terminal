...
/* ======================== Submodel Commands (0x40~0x4F) ======================== */

#define CMD_SUB_EVT_NOTIFY      0x40  /* Submodel → Core: event notification */
#define CMD_SUB_SET_MODE        0x41  /* Core → Submodel: set mode / action */
#define CMD_SUB_GET_STATUS      0x42  /* Core → Submodel: query status */
#define CMD_SUB_DATA_REPORT     0x43  /* Submodel → Core: periodic data report */
#define CMD_SUB_SET_CONFIG      0x44  /* Core → Submodel: set config params */
#define CMD_SUB_ACTION_RESULT   0x45  /* Submodel → Core: action result */
#define CMD_SUB_BULK_TRANSFER   0x46  /* Bidirectional: bulk transfer */
...
#define MODULE_SUBTYPE_TOUCH_RING  0x04
