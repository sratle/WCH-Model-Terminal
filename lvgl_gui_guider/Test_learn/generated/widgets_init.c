...
{
    digital_clock_count(&main_digital_clock_1_hour_value, &main_digital_clock_1_min_value, &main_digital_clock_1_sec_value, main_digital_clock_1_meridiem);
    if (lv_obj_is_valid(guider_ui.main_digital_clock_1))
    {
        lv_label_set_text_fmt(guider_ui.main_digital_clock_1, "%d:%02d:%02d %s", main_digital_clock_1_hour_value, main_digital_clock_1_min_value, main_digital_clock_1_sec_value, main_digital_clock_1_meridiem);
    }
}
