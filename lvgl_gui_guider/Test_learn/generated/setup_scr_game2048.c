...
void setup_scr_game2048(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->game2048_label_2048, 480, 5);
    ...
    lv_obj_set_style_text_font(ui->game2048_btn_up, &lv_font_montserratMedium_58, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_shadow_width(ui->game2048_btn_new_game, 3, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_color(ui->game2048_btn_new_game, lv_color_hex(0xBDAC97), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_opa(ui->game2048_btn_new_game, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_spread(ui->game2048_btn_new_game, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_offset_x(ui->game2048_btn_new_game, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_offset_y(ui->game2048_btn_new_game, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->game2048_btn_new_game, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->game2048_btn_new_game, &lv_font_Alatsi_Regular_33, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->game2048_btn_left, 441, 388);
    ...
    lv_obj_set_style_text_font(ui->game2048_btn_left, &lv_font_montserratMedium_58, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->game2048_btn_down, 558, 388);
    ...
    lv_obj_set_style_text_font(ui->game2048_btn_down, &lv_font_montserratMedium_58, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->game2048_btn_right, 675, 388);
    ...
    lv_obj_set_style_text_font(ui->game2048_btn_right, &lv_font_montserratMedium_58, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_border_opa(ui->game2048_cont_msgbox, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->game2048_cont_msgbox, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->game2048_cont_msgbox, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->game2048_cont_msgbox, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->game2048_cont_msgbox, 154, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->game2048_btn_again_label, "Play Again");
    ...
    lv_obj_set_style_radius(ui->game2048_btn_again, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
