...
**HID 映射方案（CH9329 混合模式）**：

| 输入设备 | CH9329 HID 映射 | 说明 |
|----------|-----------------|------|
| ROC1 X/Y | WASD 键盘键 | 摇杆方向映射为四个方向键 |
| ROC2 X/Y | 鼠标相对移动 | 保留模拟精度 |
| BUT1 | 鼠标左键 | mouse button bit0 |
| BUT2 | 鼠标右键 | mouse button bit1 |
| BUT3~BUT6 | H/J/K/L 键盘键 | |
| SW1 | Left Shift | 修饰键 bit1 |
| SW2 | Left Ctrl | 修饰键 bit0 |
| SW3 | Left Alt | 修饰键 bit2 |
| EC1 旋转 | 鼠标 X 轴偏移 | 旋转增量叠加到鼠标水平移动 |
| EC2 旋转 | 鼠标 Y 轴偏移 | 旋转增量叠加到鼠标垂直移动 |
| EC1_D / EC2_D | 鼠标中键 / 预留 | EC1_D → button bit2 |
