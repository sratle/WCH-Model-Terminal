...
/* ============================================================================
 * Laser Ranging (激光测距, type=0x06) Control API
 * Core → Laser submodel-6 命令发送函数
 * ============================================================================ */

/**
 * @brief  在 submodels_g[0..2] 中查找 Laser 类型 submodel
 * @return Laser submodel 指针, 未找到返回 NULL
 */
 ...
 * @param  submodel   目标 submodel 实例指针（需为 Laser 类型）
 * @return 1=发送成功, 0=失败
 */
