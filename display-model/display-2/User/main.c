...
#include "../Common/Common/MiniUI/font/font_montserrat_24.h"
...
int main(void)
{
    ...
    /* Enable UART2 debug CLI (waveform tuning over the debug console) */
    Debug_CLI_Init();
    ...
    /* Initialize all app modules (music, files, editor, images, ebook, stubs) */
    apps_init_all();
