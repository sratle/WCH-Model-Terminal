...
static void mine_draw_mode_btns(void)
{
    ...
    ui_draw_text_in_rect(&er, "9x9 Easy", &font_montserrat_16,
    ...
    ui_draw_text_in_rect(&hr, "16x16 Hard", &font_montserrat_16,
                         !easy_act ? UI_COLOR_WHITE : UI_COLOR_BLACK, 1);
}
...
static void mine_draw_tool_btn(void)
{
    ...
    ui_draw_text_in_rect(&tl, "TOOL", &font_montserrat_16, UI_COLOR_TEXT_SECONDARY, 1);
    ...
    ui_draw_text_in_rect(&tb, (s_mine.tool == TOOL_DIG) ? "DIG" : "FLAG",
                         &font_montserrat_24, UI_COLOR_WHITE, 1);
    ...
    if (s_mine.tool == TOOL_FLAG) {
        ui_draw_fill_round_rect(&r, 6, UI_COLOR_BLACK);
        ui_draw_text_in_rect(&r, "FLAG MODE", &font_montserrat_24, UI_COLOR_WHITE, 1);
    } else {
        ui_draw_round_rect(&r, 6, UI_COLOR_WHITE, UI_COLOR_BLACK, 1);
        ui_draw_text_in_rect(&r, "DIG MODE", &font_montserrat_24, UI_COLOR_BLACK, 1);
    }
}
...
static void mine_draw_idle_overlay(void)
{
    ...
    ui_draw_text_in_rect(&title, "MINESWEEPER", &font_montserrat_24, UI_COLOR_BLACK, 1);
...
static void mine_draw_win_overlay(void)
{
    ...
    ui_draw_text_in_rect(&sr, buf, &font_montserrat_16, UI_COLOR_BLACK, 1);
