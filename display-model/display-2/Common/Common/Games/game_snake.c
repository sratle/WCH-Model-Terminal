...
#define SNK_BG_COLOR        UI_COLOR_WHITE    /* Game area background */
#define SNK_GRID_BG         UI_COLOR_WHITE    /* Grid cell background */
#define SNK_GRID_BORDER     UI_COLOR_BLACK    /* Grid cell border */
#define SNK_SNAKE_HEAD      UI_COLOR_BLACK    /* Snake head color */
#define SNK_SNAKE_BODY      UI_COLOR_BLACK    /* Snake body color */
#define SNK_SNAKE_TAIL      UI_COLOR_BLACK    /* Snake tail */
#define SNK_FOOD_COLOR      UI_COLOR_BLACK    /* Food color */
#define SNK_FOOD_HIGHLIGHT  UI_COLOR_WHITE    /* Food highlight */
...
static void snk_draw_head(int row, int col)
{
    ...
    ui_color_t eye_color = UI_COLOR_WHITE;    /* White eyes on black head for e-ink */
...
static void snk_draw_panel(void)
{
    ...
    ui_draw_fill_round_rect(&sb, SNK_INFO_BOX_R, UI_COLOR_BLACK);
    ...
    ui_draw_fill_round_rect(&lb, SNK_INFO_BOX_R, UI_COLOR_BLACK);
    ...
    ui_draw_fill_round_rect(&bb, SNK_INFO_BOX_R, UI_COLOR_BLACK);
...
static void snk_draw_dpad(void)
{
    ui_color_t btn_bg = UI_COLOR_BLACK;
    ui_color_t btn_border = UI_COLOR_WHITE;
...
static void snk_draw_idle_overlay(void)
{
    ...
    ui_rect_t title = {SNK_GRID_X, SNK_GRID_Y + SNK_GRID_H / 2 - 30,
                       SNK_GRID_W, 30};
    ui_draw_text_in_rect(&title, "SNAKE", &font_montserrat_16, UI_COLOR_BLACK, 1);
...
static void snk_game_update(ui_page_t *page, uint32_t dt_ms)
{
    (void)page;
    snk_game_tick();
}
