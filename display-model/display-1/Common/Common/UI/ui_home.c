...
void ui_home_init(void)
{
    ...
    ui_label_init(&lbl_date, &date_rect, "2025/04/19", UI_FONT_BODY);
    ui_label_set_color(&lbl_date, UI_COLOR_TEXT_SECONDARY);

    ui_rect_t time_rect = {cx, 48, 300, 36};
    ui_label_init(&lbl_time, &time_rect, "14:30:00", UI_FONT_TITLE);
    ...
    ui_label_init(&lbl_wifi_name, &name_rect, "WiFi", UI_FONT_BODY);
