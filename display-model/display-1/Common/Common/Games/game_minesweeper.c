...
static void mine_draw_mode_btns(void)
{
    ...
    ui_draw_text_in_rect(&er, "9x9 Easy", UI_FONT_BODY, easy_text, 1);
    ...
    ui_draw_text_in_rect(&hr, "16x16 Hard", UI_FONT_BODY, hard_text, 1);
}
...
static void mine_draw_idle_overlay(void)
{
    ...
    ui_draw_text_in_rect(&title, "MINESWEEPER", UI_FONT_TITLE, UI_COLOR_WHITE, 1);
