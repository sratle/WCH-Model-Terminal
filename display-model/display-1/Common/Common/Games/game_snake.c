...
static void snk_draw_panel(void)
{
    ...
    ui_draw_text_in_rect(&sl, "SCORE", UI_FONT_BODY, UI_COLOR_TEXT_SECONDARY, 1);
    ...
    ui_draw_text_in_rect(&sb, s_snk.buf_score, UI_FONT_TITLE, UI_COLOR_WHITE, 1);

    /* Level label */
    ui_rect_t ll = {SNK_PANEL_X, SNK_LEVEL_LABEL_Y, SNK_PANEL_W, SNK_INFO_LABEL_H};
    ui_draw_text_in_rect(&ll, "LEVEL", UI_FONT_BODY, UI_COLOR_TEXT_SECONDARY, 1);
    ...
    ui_draw_text_in_rect(&lb, s_snk.buf_level, UI_FONT_TITLE, UI_COLOR_WHITE, 1);

    /* Best label */
    ui_rect_t bl = {SNK_PANEL_X, SNK_BEST_LABEL_Y, SNK_PANEL_W, SNK_INFO_LABEL_H};
    ui_draw_text_in_rect(&bl, "BEST", UI_FONT_BODY, UI_COLOR_TEXT_SECONDARY, 1);
    ...
    ui_draw_text_in_rect(&bb, s_snk.buf_best, UI_FONT_TITLE, UI_COLOR_WHITE, 1);
...
static void snk_draw_idle_overlay(void)
{
    ...
    ui_rect_t title = {SNK_GRID_X, SNK_GRID_Y + SNK_GRID_H / 2 - 30,
                       SNK_GRID_W, 30};
    ui_draw_text_in_rect(&title, "SNAKE", UI_FONT_TITLE, UI_COLOR_WHITE, 1);

    ui_rect_t sub = {SNK_GRID_X, SNK_GRID_Y + SNK_GRID_H / 2 + 5,
                     SNK_GRID_W, 24};
    ui_draw_text_in_rect(&sub, "Swipe or press to start", UI_FONT_BODY,
                         UI_HEX(0xAAAAAA), 1);
}
