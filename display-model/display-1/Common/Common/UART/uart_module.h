...
/*=============================================================================
 *  NFC Sub-commands (forwarded via DISP_EXT_SUBMODEL_EVENT)
 *=============================================================================*/
 ...
 *
 *  Core pushes DISP_EXT_USER_STATUS on login/logout/switch. Apps that need
 *  to react (e.g. File Manager auth dialog auto-retry) register a callback;
